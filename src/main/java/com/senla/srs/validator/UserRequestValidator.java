...
@Service
public class UserRequestValidator implements DtoValidator<User, UserRequestDTO> {

    @Override
    public void validateDtoFromAdmin(UserRequestDTO requestDto, Errors errors) {
    ...
    @Override
    public void validateNewDto(UserRequestDTO requestDto, Errors errors) {
    ...
    @Override
    public void validateExistDto(UserRequestDTO requestDto, Errors errors, Optional<User> optionalDto) {
